...
// Funciones para habilitar botones Editar y Eliminar
...
const editarPaciente = (index) => {
    ...
    // Eliminar el paciente del array para luego agregarlo editado
    arrayPaciente.splice(index, 1);
    
    mensaje.innerHTML = "Paciente cargado para editar";
    toast.show();
};
...
//Funcion que imprime la ficha de los pacientes registrados (VERSIÓN CON BOTONES FUNCIONALES)
